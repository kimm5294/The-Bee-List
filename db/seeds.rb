...
Goal.create(task:"Harry Potter and the Goblet of Fire", category_id:1, goal_id: "tt0330373")
Goal.create(task:"Pacific Rim", category_id:1, goal_id: "tt1663662")
Goal.create(task:"Muppets", category_id:1, goal_id: "tt1204342")
Goal.create(task:"Spectre", category_id:1, goal_id: "tt2379713")
Goal.create(task:"The Man with the Golden Gun", category_id:1, goal_id: "tt0071807")
Goal.create(task:"The Notebook", category_id:1, goal_id: "tt0332280")
Goal.create(task:"Transformers", category_id:1, goal_id: "tt0418279")
Goal.create(task:"The Devil Wears Prada", category_id:1, goal_id: "tt0458352")
Goal.create(task:"The Godfather", category_id:1, goal_id: "tt0068646")
Goal.create(task:"Scarface", category_id:1, goal_id: "tt0086250")
Goal.create(task:"Horton Hears a Who", category_id:1, goal_id: "tt0451079")
Goal.create(task:"Pokemon 2000", category_id:1, goal_id: "tt0382918")

Goal.create(task:"Game of Thrones", category_id:2, goal_id: "tt0944947")
Goal.create(task:"The Americans", category_id:2, goal_id: "tt2149175")
Goal.create(task:"Chopped", category_id:2, goal_id: "tt1353281")
Goal.create(task:"Iron Chef", category_id:2, goal_id: "tt0220265")
Goal.create(task:"Smallville", category_id:2, goal_id: "tt0279600")
Goal.create(task:"Whale Wars", category_id:2, goal_id: "tt1195419")
Goal.create(task:"Survivorman", category_id:2, goal_id: "tt0770659")
Goal.create(task:"Sons of Anarchy", category_id:2, goal_id: "tt1124373")
Goal.create(task:"Duck Dynasty", category_id:2, goal_id: "tt2229907")
Goal.create(task:"Legion", category_id:2, goal_id: "tt1038686")
Goal.create(task:"Westworld", category_id:2, goal_id: "tt0475784")
Goal.create(task:"Silicon Valley", category_id:2, goal_id: "tt2575988")
Goal.create(task:"Parks and Recreation", category_id:2, goal_id: "tt1266020")
Goal.create(task:"The Office", category_id:2, goal_id: "tt0386676")

Goal.create(task:"Dr. No: James Bond 007", category_id:3, goal_id: "83I9F0ChS1oC")
Goal.create(task:"Goldeneye 007: Unauthorized Game Secrets", category_id:3, goal_id: "KzmZPQAACAAJ")
Goal.create(task:"A Tale of Two Cities", category_id:3, goal_id: "nuTsYEwx_iwC")
Goal.create(task:"The Hobbit", category_id:3, goal_id: "hFfhrCWiLSMC")
Goal.create(task:"Moonraker", category_id:3, goal_id: "Zph_XxHy4AAC")
Goal.create(task:"Jurassic Park", category_id:3, goal_id: "I79dV_HQvykC")
Goal.create(task:"The Lost World", category_id:3, goal_id: "oNEQAAAAYAAJ")
Goal.create(task:"The DaVinci Code", category_id:3, goal_id: "YuDl2Wl651AC")
Goal.create(task:"The Kite Runner", category_id:3, goal_id: "MH48bnzN0LUC")
Goal.create(task:"Romeo and Juliet", category_id:3, goal_id: "6rhaAAAAcAAJ")
Goal.create(task:"Much Ado About Nothing", category_id:3, goal_id: "0GmmbXRahAkC")
Goal.create(task:"Twenty Thousand Leagues Under the Sea", category_id:3, goal_id: "RqlEAAAAYAAJ")
Goal.create(task:"Friday Night Lights", category_id:3, goal_id: "aRZpCQAAQBAJ")
Goal.create(task:"The Blindside", category_id:3, goal_id: "jeVS4jRjSlQC")

Goal.create(task:"Paris", category_id:4, goal_id: "ChIJD7fiBh9u5kcRYJSMaMOCCwQ")
Goal.create(task:"Milan", category_id:4, goal_id: "ChIJ53USP0nBhkcRjQ50xhPN_zw")
Goal.create(task:"Rome", category_id:4, goal_id: "ChIJDYryPb4O2YkR97P8bHEaoEo")
Goal.create(task:"Toronto", category_id:4, goal_id: "ChIJpTvG15DL1IkRd8S0KlBVNTI")
Goal.create(task:"Seoul", category_id:4, goal_id: "ChIJzWXFYYuifDUR64Pq5LTtioU")
Goal.create(task:"Beijing", category_id:4, goal_id: "ChIJuSwU55ZS8DURiqkPryBWYrk")
Goal.create(task:"Tokyo", category_id:4, goal_id: "ChIJ51cu8IcbXWARiRtXIothAS4")
Goal.create(task:"Tanzania", category_id:4, goal_id: "ChIJEaFpSDFRSxgRMMTBSzEXWog")
Goal.create(task:"New Zealand", category_id:4, goal_id: "ChIJh5Z3Fw4gLG0RM0dqdeIY1rE")
Goal.create(task:"Christmas Island", category_id:4, goal_id: "ChIJz6fA4yea9S4RFup1BAnW5xU")
Goal.create(task:"Iceland", category_id:4, goal_id: "ChIJQ2Dro1Ir0kgRmkXB5TQEim8")
Goal.create(task:"New York City", category_id:4, goal_id: "ChIJOwg_06VPwokRYv534QaPC8g")
Goal.create(task:"Madrid", category_id:4, goal_id: "ChIJgTwKgJcpQg0RaSKMYcHeNsQ")
Goal.create(task:"Moscow", category_id:4, goal_id: "ChIJDaDKkrXCxIkR16VXi1WamHU")

Goal.create(task:"Le Bernardin", category_id:5, goal_id: "ChIJVSKXkPhYwokRVgXdrRfFxh0")
Goal.create(task:"McDonald's", category_id:5, goal_id: "ChIJ2_VLfRdawokRXKfA6CMf5YQ")
Goal.create(task:"Per Se", category_id:5, goal_id: "ChIJp3PsL_ZYwokRZYqs_40RJF4")
Goal.create(task:"Eleven Madison Park", category_id:5, goal_id: "ChIJEWbXz6ZZwokRLKmKrtPfVFY")
Goal.create(task:"Jean-Georges", category_id:5, goal_id: "ChIJh5JzbfZYwokRR7KqJOksL7Y")
Goal.create(task:"The Seafire Grill", category_id:5, goal_id: "ChIJpYNIR_1YwokRNMXI4Qk1lwQ")
Goal.create(task:"Gotham Bar and Grill", category_id:5, goal_id: "ChIJZ72FzplZwokRmcA7CQzDMj0")
Goal.create(task:"Somtum Der", category_id:5, goal_id: "ChIJY_1BtoJZwokR-sB-pdEPW44")
Goal.create(task:"Morimoto", category_id:5, goal_id: "ChIJTyXzusBZwokRtkOSoqQgYAM")
Goal.create(task:"Momofuku Ssam Bar", category_id:5, goal_id: "ChIJkXQ3_INZwokRbCMEByaQ_VE")
Goal.create(task:"Alinea", category_id:5, goal_id: "ChIJuyI60yLTD4gROwTWENq1He0")
Goal.create(task:"Peter Luger Steakhouse", category_id:5, goal_id: "ChIJR_bK295bwokR8gM6QgEdmkY")
Goal.create(task:"Smith and Wollensky", category_id:5, goal_id: "ChIJSRfEz-JYwokRA5qI_DOzkKg")
